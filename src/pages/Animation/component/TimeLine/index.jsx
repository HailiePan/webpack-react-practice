 ...
 * @LastEditTime: 2024-01-15 23:07:38
 * @Description: 
 */
  ...
  return (
    <div>
        ...
        <div style={{marginBottom:'10px'}}>
          ...
          <Button onClick={()=>handleClickSuspend()} style={{margin:'0 6px'}}>暂停</Button>
        ...
        <div style={{display:'flex',marginTop:'50px'}}>
          <div className={styles.text} ref={text1}>G</div>
          <div className={styles.text} ref={text2}>S</div>
          <div className={styles.text} ref={text3}>A</div>
          <div className={styles.text} ref={text4}>P</div>
        </div>
    </div>
  )
}

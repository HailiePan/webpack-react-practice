 ...
 * LastEditTime  2023-11-29 17:42:37
  ...
  return (
    <div>
      <ul>
        ...
        <li>封装受控的下拉选择组件，</li>
        <li>快速封装带背景的组件；</li>
        <li>思考的问题：什么时候需要监听父组件传入的数据，传入的数据变化时做一些事情；</li>
      </ul>

      <EquipInfo count={count} testValue={testValue} />

      <SearchInput selectValue={selectValue} onSelectChange={(value) => setSelectValue(value)} />

      <CommonBox style={{ width: '640px', height: '500px', marginTop: '100px' }}>
        <div>内容1</div>
        <div>内容1</div>
        <div>内容1</div>
      </CommonBox>
